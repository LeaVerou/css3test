	...
	"properties": {
		...
		"text-overflow": {
			...
			"tests": [
				...
				"ellipsis fade", "fade fade", "fade(10px) fade", "fade(10%) fade", "'foo' fade",
				"clip fade(10px)", "ellipsis fade(10px)", "fade fade(10px)",
				"fade(10px) fade(10px)", "fade(10%) fade(10px)", "'foo' fade(10px)",
				"clip fade(10%)", "ellipsis fade(10%)", "fade fade(10%)", "fade(10px) fade(10%)",
				"fade(10%) fade(10%)", "'foo' fade(10%)", "clip 'foo'", "ellipsis 'foo'",
				"fade 'foo'", "fade(10px) 'foo'", "fade(10%) 'foo'", "'foo' 'foo'"
			]
		},
		"user-select": {
			"links": {
