	...
	"css-animations-2": {
		...
		"properties": {
			...
			"animation-timeline": {
				...
				"tests": ["auto", "none", "custom-timeline", "\"custom-timeline\"", "auto, none, custom-timeline, \"custom-timeline\""]
			},
			"animation": {
				"links": {
					"tr": "#animation-timeline",
	...
	"scroll-animations-1": {
		...
		"@rules": {
			"@scroll-timeline": {
				...
				"tests": [
					"@scroll-timeline scroller { source: selector(#root); }"
				]
			}
		},
		"descriptors": {
			...
			"@scroll-timeline example/offsets": {
				...
				"tests": [
					"none", "auto", "100px", "5%", "selector(#id)", "selector(#id) start",
					"selector(#id) end", "selector(#id) 0.5", "selector(#id) start 0.5",
